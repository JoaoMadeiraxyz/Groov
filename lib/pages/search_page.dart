  ...
  static final List<Map<String, dynamic>> _userProfiles = [
    {
      ...
      'favoriteArtists': const [
        Artist(name: 'Sleep Token', imageUrl: 'https://i.scdn.co/image/ab6761610000e5ebd00c2ff422829437e6b5f1e0'),
        Artist(name: 'Joji',        imageUrl: 'https://i.scdn.co/image/ab67616100005174b6d7836808e8b99fc8c7aadc'),
      ],
      'playlists': const [
        Playlist(name: 'Meu Top Mix',   public: true,  imageUrl: 'https://upload.wikimedia.org/wikipedia/en/c/c1/The_Weeknd_-_After_Hours.png'),
        Playlist(name: 'Rock Pesado',   public: true,  imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb3dc0577ed61ec73b498a56ee'),
    ...
    },
    {
      ...
      'favoriteArtists': const [
        Artist(name: 'Billie Eilish', imageUrl: 'https://atwoodmagazine.com/wp-content/uploads/2024/06/HIT-ME-HARD-AND-SOFT-Billie-Eilish-album-cover-1170x780.jpeg'),
        Artist(name: 'Jutes',         imageUrl: 'https://i.scdn.co/image/ab67616d0000b27358092b5a587026b6b4c89f6c'),
      ],
      'playlists': const [
    ...
    },
    {
      ...
      'favoriteArtists': const [
        Artist(name: 'Bad Omens',   imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb3dc0577ed61ec73b498a56ee'),
        Artist(name: 'Sleep Token', imageUrl: 'https://i.scdn.co/image/ab6761610000e5ebd00c2ff422829437e6b5f1e0'),
      ],
      'playlists': const [
        Playlist(name: 'Rock Pesado', public: true, imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb3dc0577ed61ec73b498a56ee'),
